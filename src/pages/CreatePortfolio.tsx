...
import { TrendingUp, ArrowLeft, Loader2, Globe, Lock, Users, Plus, Trash2, Upload } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const previewResponse = await fetch(`${API_BASE_URL}/api/portfolios?preview=true`, {
        ...
        body: JSON.stringify({ holdings: holdingsInput }),
      });
          ...
          <div className="bg-card rounded-2xl border border-border max-w-2xl w-full p-6 my-8">
            <div className="flex items-start justify-between mb-4">
              ...
              <button
                ...
                className="p-1 hover:bg-card-hover rounded-lg transition-colors text-text-secondary"
              >
                &times;
              </button>
            </div>
